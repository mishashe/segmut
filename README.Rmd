...
```{r plot density results,fig.width=5, fig.height=5, message=FALSE, warning=FALSE, out.width="50%"}
...
```{r blocks, echo=TRUE, fig.height=5, fig.width=5, message=FALSE, warning=FALSE, out.width="50%"}
...
```{r plot segments,fig.width=10, fig.height=0.5, echo=TRUE, message=FALSE, warning=FALSE,fig.width=5, fig.height=5, out.width="50%"}
...
```{r mld,fig.width=10, fig.height=0.5, echo=TRUE, message=FALSE, warning=FALSE,fig.width=4, fig.height=4, out.width="50%"}
...
```{r human breaking to segments,fig.width=10, fig.height=0.5, echo=TRUE, message=FALSE, warning=FALSE,fig.width=8, fig.height=4, out.width="50%"}
