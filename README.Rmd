...
```{r blocks, echo=TRUE, fig.height=8, fig.width=8, message=FALSE, warning=FALSE}
...
for (i in order(-nchar(alignment)))
{
  ...
  breaks <- sort(getNumberBreaksChiSquare(muts,L=L,Kmin=10))
...
```{r plot segments,fig.width=10, fig.height=0.5, echo=TRUE, message=FALSE, warning=FALSE,fig.width=8, fig.height=8}
...
```{r mld,fig.width=10, fig.height=0.5, echo=TRUE, message=FALSE, warning=FALSE,fig.width=8, fig.height=8}
